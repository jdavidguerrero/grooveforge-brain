...
static constexpr uint8_t VIEW_IDX_AI_PROC       = 9;   ///< view_10 — AI processing (resultados ML)
static constexpr uint8_t VIEW_IDX_SYNTH_FILTER  = 23;  ///< view_24 — FILTER group (PARAM_LIST level 2)
static constexpr uint8_t VIEW_IDX_AI_MODELS     = 24;  ///< view_25 — AI MODELS toggle (Sprint 32)
static constexpr uint8_t VIEW_IDX_AI_KARAOKE    = 25;  ///< view_26 — KARAOKE nota activa (Sprint 34)
static constexpr uint8_t VIEW_IDX_AI_FEED       = 26;  ///< view_27 — AI FEED status panel (Sprint 34)
static constexpr uint8_t VIEW_IDX_AI_RACK       = 27;  ///< view_28 — AI RACK control surface (Sprint 45)
